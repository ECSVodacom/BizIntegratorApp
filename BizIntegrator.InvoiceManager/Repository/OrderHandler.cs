...
namespace BizIntegrator.Service.Repository
{
    public class OrderHandler
    {
        ...
        public void ConfirmOrders(string ordNo, string ordContent, string id, string name, string url, string apiKey, string privateKey, string username, string password, string authenticationType, string useAPIKey)
        {
            RestHandler restHandler = new RestHandler();
            DataHandler dataHandler = new DataHandler();
            HttpClient client;
